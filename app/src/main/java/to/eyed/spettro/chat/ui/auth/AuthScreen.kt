...
import to.eyed.spettro.chat.ui.components.MeshBackground
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        Box(Modifier.fillMaxSize().padding(24.dp), contentAlignment = Alignment.Center) {
            Column(
                Modifier
                    .widthIn(max = 448.dp)
                    .glassStrong(RoundedCornerShape(Radii.sheet), refraction = true)
                    .padding(32.dp),
                ...
                Box(
                    Modifier
                        .whiteGlow(RoundedCornerShape(Radii.card))
                        .size(64.dp)
                        .glass(RoundedCornerShape(Radii.card)),
                    contentAlignment = Alignment.Center,
                ) {
                    Icon(Icons.Rounded.AutoAwesome, null, Modifier.size(26.dp), tint = Ink.White)
                }
                Spacer(Modifier.height(20.dp))
                Text("Spettro Chat", style = androidx.compose.material3.MaterialTheme.typography.headlineSmall, color = Ink.White)
...
private fun IdleContent(onSignIn: () -> Unit) {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        PrimaryButton(
            ...
            Icon(Icons.AutoMirrored.Rounded.ArrowForward, null, Modifier.size(16.dp), tint = Ink.Pitch)
        }
        Spacer(Modifier.height(20.dp))
        Text(
            "A secure sign-in page opens in your browser. No passwords are stored in the app.",
            color = Ink.I500,
            fontSize = 11.sp,
            lineHeight = 15.sp,
            textAlign = TextAlign.Center,
...
private fun WaitingContent(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Spacer(Modifier.height(16.dp))
        Text(title, color = Ink.I100, fontSize = 14.sp, fontWeight = FontWeight.Medium)
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            GlassButton("Cancel", onClick = onCancel, textColor = Ink.I500)
        }
    }
}
